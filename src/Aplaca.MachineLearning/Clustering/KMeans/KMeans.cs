...
namespace Accord.MachineLearning
{
    ...
    ///
    [Serializable, SerializationBinder(typeof(KMeans.KMeansBinder))]
#if !NETSTANDARD1_4
#endif
...
#pragma warning restore 0618
    {
        ...
        /// use the <see cref="SquareEuclidean"/> distance.</param>
        /// 
        ...
        public KMeans(int k, Func<double[], double[], double> distance)
            : this(k, Alpaca.Math.Distance.GetDistance(distance))
        {
        }
        ...
        /// 
        public KMeans(int k)
            : this(k, new Alpaca.Math.Distances.SquareEuclidean()) { }
        ...
        /// <see cref="SquareEuclidean"/> distance.</param>
        /// 
        ...
        public void Randomize(double[][] points)
        {
            ...
            Alpaca.Clustering.Core.Debug.Assert(clusters.NumberOfInputs == points[0].Length);
        }
        ...
        public virtual KMeansClusterCollection Learn(double[][] x, double[] weights = null)
        {
            ...
            Alpaca.Clustering.Core.Debug.Assert(clusters.NumberOfClasses == K);
            Alpaca.Clustering.Core.Debug.Assert(clusters.NumberOfOutputs == K);
            Alpaca.Clustering.Core.Debug.Assert(clusters.NumberOfInputs == x[0].Length);
...
#pragma warning disable 0649
        ...
        class KMeans_2_13
        {
            ...
            public static implicit operator KMeans(KMeans_2_13 obj)
            {
                ...
                var dist = Alpaca.Math.Distance.GetDistance(func);
