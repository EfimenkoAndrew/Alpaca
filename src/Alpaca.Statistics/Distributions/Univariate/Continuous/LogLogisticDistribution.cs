...
namespace Accord.Statistics.Distributions.Univariate
{
    ...
    public class LogLogisticDistribution : UnivariateContinuousDistribution
    {
        ...
        public override double Median
        {
            get
            {
                Alpaca.Clustering.Core.Debug.Assert(alpha == base.Median);
                return alpha;
            }
        }
        ...
        public override double QuantileDensityFunction(double p)
        {
            ...
            Alpaca.Clustering.Core.Debug.Assert(qdf == base.QuantileDensityFunction(p));
        ...
        protected internal override double InnerComplementaryDistributionFunction(double x)
        {
            ...
            Alpaca.Clustering.Core.Debug.Assert(icdf.IsEqual(base.InnerComplementaryDistributionFunction(x), 1e-10));
        ...
        public override double HazardFunction(double x)
        {
            ...
            Alpaca.Clustering.Core.Debug.Assert(h.IsEqual(base.HazardFunction(x), 1e-10));
