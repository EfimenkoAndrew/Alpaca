...
namespace Accord.Math
{
    ...
    public static partial class Matrix
    {
            ...
            where T : IComparable<T>
        {
            ...
            Alpaca.Math.Sort.Insertion(work, idx, 0, count, asc: false);
            ...
            where T : IComparable<T>
        {
            ...
            Alpaca.Math.Sort.Insertion(work, idx, 0, count, asc: true);
            return idx.First(count);
        }
        ...
        public static int Partition<T, TValue>(this T[] list, TValue[] keys, int left, int right, bool asc = true)
            where T : IComparable<T>
        {
            return Alpaca.Math.Sort.Partition(list, left, right, asc);
        }
        ...
        {
            return Alpaca.Math.Sort.Partition(list, keys, left, right, compare, asc: asc);
        }
        ...
        {
            return Alpaca.Math.Sort.Partition(list, left, right, compare, asc: asc);
        }
