...
namespace Accord.MachineLearning.VectorMachines
{
    ...
    /// 
    [Serializable, Obsolete("Please use MultilabelSupportVectorMachine<TKernel> instead."),
...
#pragma warning restore 0618
        ...
        /// 
        [Obsolete("Please use Alpaca.Clustering.Core.Serializer.Load<MultilabelSupportVectorMachine>(stream) instead.")]
        public static MultilabelSupportVectorMachine Load(Stream stream)
        {
            return Alpaca.Clustering.Core.Serializer.Load<MultilabelSupportVectorMachine>(stream);
        }
        ...
        /// <returns>The deserialized machine.</returns>
        /// 
        [Obsolete("Please use Alpaca.Clustering.Core.Serializer.Load<MultilabelSupportVectorMachine>(path) instead.")]
        public static MultilabelSupportVectorMachine Load(string path)
        {
            return Alpaca.Clustering.Core.Serializer.Load<MultilabelSupportVectorMachine>(path);
        }
#endif
