...
namespace Alpaca.Math.AForge.Math.Random
{
    /// <summary>
    ...
    public class UniformGenerator : IRandomNumberGenerator
    {
        ...
        {
            get { return new Clustering.Core.Ranges.Range(min, min + length); }
        }
        ...
        /// 
        public UniformGenerator(Clustering.Core.Ranges.Range range)
            : this(range, 0)
        {
        }
        ...
        /// 
        public UniformGenerator(Clustering.Core.Ranges.Range range, int seed)
        {
