...
#pragma warning disable 612, 618
        ...
        ISupervisedLearning, ISupervisedLearning<HiddenMarkovModel, int[], int[]>
    {
        ...
        void run(int[][] observations, int[][] paths)
        {
            ...
            Alpaca.Clustering.Core.Debug.Assert(!model.LogInitial.HasNaN());
            Alpaca.Clustering.Core.Debug.Assert(!model.LogTransitions.HasNaN());
            Alpaca.Clustering.Core.Debug.Assert(!model.Emissions.HasNaN());
        }
