...
namespace Accord.MachineLearning.DecisionTrees
{
    ...
    /// 
    [Serializable, SerializationBinder(typeof(DecisionTree.DecisionTreeBinder))]
    public class DecisionTree : MulticlassClassifierBase, IEnumerable<DecisionNode>
    {
...
#if !NETSTANDARD1_4
        /// <summary>
        ///   Obsolete. Please use <see cref="Serializer.Save{T}(T, string)"/> (or use it as an extension method).
        /// </summary>
        /// 
        [Obsolete(
            "Please use Alpaca.Clustering.Core.Serializer.Save(path) instead (or use it as an extension method).")]
        ...
        /// <summary>
        ///   Obsolete. Please use <see cref="Serializer.Save{T}(TSerializerCompressionompression)"/> (or use it as an extension method).
        /// </summary>
        /// 
        [Obsolete(
            "Please use Alpaca.Clustering.Core.Serializer.Save(stream) instead (or use it as an extension method).")]
        ...
        /// <summary>
        ///   Obsolete. Please use <see cref="Serializer.Load{TSerializerCompressionompression)"/>.
        /// </summary>
        /// 
        [Obsolete("Please use Alpaca.Clustering.Core.Serializer.Load<DecisionTree>(stream) instead.")]
        public static DecisionTree Load(Stream stream)
        {
            return Alpaca.Clustering.Core.Serializer.Load<DecisionTree>(stream);
        }

        /// <summary>
        ///   Obsolete. Please use <see cref="Serializer.Load{T}(string)"/>.
        /// </summary>
        /// 
        [Obsolete("Please use Alpaca.Clustering.Core.Serializer.Load<DecisionTree>(path) instead.")]
        public static DecisionTree Load(string path)
        {
            return Alpaca.Clustering.Core.Serializer.Load<DecisionTree>(path);
        }
#endif
