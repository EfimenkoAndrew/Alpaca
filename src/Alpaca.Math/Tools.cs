...
using Alpaca.Clustering.Core.AForge.Core;
using Alpaca.Clustering.Core.Ranges;
using Range = Alpaca.Clustering.Core.Ranges.Range;
    ...
    public static partial class Tools
    {
        ...
        public static float Angle(float x, float y)
        {
            if (y >= 0)
            {
                ...
                return (float)(System.Math.PI - System.Math.Atan(-y / x));
            }
            else
            {
                if (x >= 0)
                    return (float)(2 * System.Math.PI - System.Math.Atan(-y / x));
                return (float)(System.Math.PI + System.Math.Atan(y / x));
            }
        }
        ...
        public static double Angle(double x, double y)
        {
            if (y >= 0)
            {
                ...
                return System.Math.PI - System.Math.Atan(-y / x);
            }
            else
            {
                if (x >= 0)
                    return 2.0 * System.Math.PI - System.Math.Atan2(-y, x);
                return System.Math.PI + System.Math.Atan(y / x);
            }
        }
        ...
        public static int Direction(IntPoint previous, IntPoint next)
        {
            ...
            double radians = Tools.Angle(dx, dy);
        ...
        {
            int x = a - b * (int)System.Math.Floor(a / (double)b);
            while (x != 0)
            {
                a = b;
                b = x;
                x = a - b * (int)System.Math.Floor(a / (double)b);
            }
            return b;
        }
