...
namespace Accord.MachineLearning.VectorMachines
{
    ...
    ///
    [Serializable, Obsolete("Please use MulticlassSupportVectorMachine<TKernel> instead."),
...
#pragma warning restore 0618
        ...
        /// 
        [Obsolete("Please use Alpaca.Clustering.Core.Serializer.Save() instead (or use it as an extension method).")]
        ...
        /// 
        [Obsolete("Please use Alpaca.Clustering.Core.Serializer.Load<MulticlassSupportVectorMachine>(stream) instead.")]
        public static MulticlassSupportVectorMachine Load(Stream stream)
        {
            return Alpaca.Clustering.Core.Serializer.Load<MulticlassSupportVectorMachine>(stream);
        }
        ...
        /// <returns>The deserialized machine.</returns>
        /// 
        [Obsolete("Please use Alpaca.Clustering.Core.Serializer.Load<MulticlassSupportVectorMachine>(path) instead.")]
        public static MulticlassSupportVectorMachine Load(string path)
        {
            return Alpaca.Clustering.Core.Serializer.Load<MulticlassSupportVectorMachine>(path);
        }
#endif
        #endregion
