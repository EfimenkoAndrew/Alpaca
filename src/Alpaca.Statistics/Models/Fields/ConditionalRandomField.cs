...
namespace Accord.Statistics.Models.Fields
{
    ...
    public class ConditionalRandomField<T> : TaggerBase<T>
    {
        ...
        public double LogLikelihood(T[] observations, int[] labels)
        {
            ...
            Alpaca.Clustering.Core.Debug.Assert(!Double.IsNaN(p));
            Alpaca.Clustering.Core.Debug.Assert(!Double.IsInfinity(p));

            Alpaca.Clustering.Core.Debug.Assert(!Double.IsNaN(z));
            Alpaca.Clustering.Core.Debug.Assert(!Double.IsInfinity(z));
        ...
        public double LogLikelihood(T[][] observations, int[][] labels)
        {
            ...
            Alpaca.Clustering.Core.Debug.Assert(!Double.IsInfinity(logLikelihood));
