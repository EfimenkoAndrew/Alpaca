...
namespace Accord.Statistics.Kernels
{
        ...
        ITransform, IKernel<Sparse<double>>, ILinear<Sparse<double>>, IDistance<Sparse<double>>
    {
        ...
        public double Distance(Sparse<double> x, Sparse<double> y)
        {
            ...
            return Alpaca.Math.Distance.SquareEuclidean(x, y);
        }
        ...
        {
            return Alpaca.Clustering.Core.Sparse.FromDense(Compress(weights, supportVectors.ToDense(), out c));
        }
        ...
        {
            return Alpaca.Clustering.Core.Sparse.FromDense(values);
        }
        ...
        {
            return Alpaca.Clustering.Core.Sparse.ToDense(input);
        }
    }
}
