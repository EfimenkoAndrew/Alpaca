...
namespace Alpaca.Math.AForge.Math
{
    /// <summary>
    ...
    {
        private int[] values;
        private Clustering.Core.Ranges.Range range;
        ...
        /// </summary>
        /// 
        public Clustering.Core.Ranges.Range Range
        {
            get { return range; }
        }
        ...
        /// </remarks>
        /// 
        public ContinuousHistogram(int[] values, Clustering.Core.Ranges.Range range)
        {
            this.values = values;
            this.range = range;
        ...
        /// </remarks>
        /// 
        public Clustering.Core.Ranges.Range GetRange(float percent)
        {
            int min, max, hits;
            ...
            return new Clustering.Core.Ranges.Range(
