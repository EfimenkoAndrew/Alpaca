...
#pragma warning disable 612, 618
    ...
    public static partial class ForwardBackwardAlgorithm
    {
        ...
        public static void Forward(HiddenMarkovModel model, int[] observations, double[] scaling, double[,] fwd)
        {
            ...
            Alpaca.Clustering.Core.Debug.Assert(fwd.GetLength(0) >= T);
            Alpaca.Clustering.Core.Debug.Assert(fwd.GetLength(1) == states);
            Alpaca.Clustering.Core.Debug.Assert(scaling.Length >= T);
            ...
            Alpaca.Clustering.Core.Debug.Assert(!fwd.HasNaN());
        }
        ...
        public static void Backward(HiddenMarkovModel model, int[] observations, double[] scaling, double[,] bwd)
        {
            ...
            // Ensures minimum requirements
            Alpaca.Clustering.Core.Debug.Assert(bwd.GetLength(0) >= T);
            Alpaca.Clustering.Core.Debug.Assert(bwd.GetLength(1) == states);
            ...
            Alpaca.Clustering.Core.Debug.Assert(!bwd.HasNaN());
        }
        ...
        public static void LogForward(HiddenMarkovModel model, int[] observations, double[,] lnFwd)
        {
            ...
            // Ensures minimum requirements
            Alpaca.Clustering.Core.Debug.Assert(lnFwd.GetLength(0) >= T);
            Alpaca.Clustering.Core.Debug.Assert(lnFwd.GetLength(1) == states);
            ...
            Alpaca.Clustering.Core.Debug.Assert(!lnFwd.HasNaN());
        }
        ...
        public static void LogBackward(HiddenMarkovModel model, int[] observations, double[,] lnBwd)
        {
            ...
            // Ensures minimum requirements
            Alpaca.Clustering.Core.Debug.Assert(lnBwd.GetLength(0) >= T);
            Alpaca.Clustering.Core.Debug.Assert(lnBwd.GetLength(1) == states);
            ...
            Alpaca.Clustering.Core.Debug.Assert(!lnBwd.HasNaN());
        }
