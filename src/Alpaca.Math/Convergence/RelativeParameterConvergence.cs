...
namespace Alpaca.Math.Convergence
{
    /// <summary>
        ...
        public bool HasConverged
        {
            get
            {
                ...
                if (tolerance > 0)
                {
                    ...
                    maxChange = System.Math.Abs(OldValues[0] - NewValues[0]) / System.Math.Abs(OldValues[0]);
                    ...
                    {
                        double delta = System.Math.Abs(OldValues[i] - NewValues[i]) / System.Math.Abs(OldValues[i]);
