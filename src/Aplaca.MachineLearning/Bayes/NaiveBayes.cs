...
using Alpaca.Clustering.Core.Attributes;
using Alpaca.Math;
...
namespace Accord.MachineLearning.Bayes
{
    ...
    /// 
    [Serializable, SerializationBinder(typeof(NaiveBayes.NaiveBayesBinder))]
    public class NaiveBayes : NaiveBayes<GeneralDiscreteDistribution, int>
    {
        ...
        /// 
        [Obsolete("Please use Alpaca.Clustering.Core.Serializer.Save(stream) instead (or use it as an extension method).")]

        public virtual void Save(Stream stream)
        {
            Alpaca.Clustering.Core.Serializer.Save(this, stream);
        }
        ...
        /// 
        [Obsolete("Please use Alpaca.Clustering.Core.Serializer.Save(path) instead (or use it as an extension method).")]

        public void Save(string path)
        {
            Alpaca.Clustering.Core.Serializer.Save(this, path);
        }
        ...
        /// 
        [Obsolete("Please use Alpaca.Clustering.Core.Serializer.Load<NaiveBayes>(stream) instead.")]

        public static NaiveBayes Load(Stream stream)
        {
            return Alpaca.Clustering.Core.Serializer.Load<NaiveBayes>(stream);
        }
        ...
        /// <returns>The deserialized machine.</returns>
        /// 
        [Obsolete("Please use Alpaca.Clustering.Core.Serializer.Load<NaiveBayes>(path) instead.")]

        public static NaiveBayes Load(string path)
        {
            return Alpaca.Clustering.Core.Serializer.Load<NaiveBayes>(path);
        }
        ...
        /// <returns>The deserialized machine.</returns>
        /// 
        [Obsolete("Please use Alpaca.Clustering.Core.Serializer.Load<NaiveBayes<TDistribution>>(stream) instead.")]
        ...
        {
            return Alpaca.Clustering.Core.Serializer.Load<NaiveBayes<TDistribution>>(stream);
        }
        ...
        /// <returns>The deserialized machine.</returns>
        /// 
        [Obsolete("Please use Alpaca.Clustering.Core.Serializer.Load<NaiveBayes<TDistribution>>(path) instead.")]

        public static NaiveBayes<TDistribution> Load<TDistribution>(string path)
            where TDistribution : IFittableDistribution<double>, IUnivariateDistribution<double>,
            IUnivariateDistribution
        {
            return Alpaca.Clustering.Core.Serializer.Load<NaiveBayes<TDistribution>>(path);
        }
#endif
#endregion
