...
namespace Accord.Statistics.Testing
{
    ...
    public class MannWhitneyWilcoxonTest : HypothesisTest<MannWhitneyDistribution>
    {
            ...
            bool? exact = null, bool adjustForTies = true)
        {
            ...
            // Alpaca.Clustering.Core.Debug.Assert(RankSum2 == n * (n + 1) / 2 - RankSum1);
            ...
            // Alpaca.Clustering.Core.Debug.Assert(Statistic1 + Statistic2 == NumberOfSamples1 * NumberOfSamples2);

            Alpaca.Clustering.Core.Debug.Assert(Statistic1 == MannWhitneyDistribution.MannWhitneyU(Rank1));
            Alpaca.Clustering.Core.Debug.Assert(Statistic2 == MannWhitneyDistribution.MannWhitneyU(Rank2));
